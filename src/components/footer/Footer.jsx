...
const Footer = () => {
    return (
        <footer>
            <div className="container section-padding text-center footer">
                <h1 className="content-title">Newsletter</h1>
                ...
                <div className="footer-bottom mt-5">
                    ...
                    <div>
                        <p className='copy-right-text'>Space {new Date().getFullYear()}, All rights reserved.</p>
                    </div>
                    <div className="social d-flex justify-space-between align-items-center">
